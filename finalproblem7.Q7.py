#Q7: Georgia Tech played in the SEC from 1933 to 1963. 
# What was its record during this time? 
...
def import_file_contents_into_dictionary(file_contents):
    ...
    for index in range(1, len(file_contents)):
        ...
        if not opponent in georgia_tournament_played.keys():
            ...
            'Points Won between 1933 and 1963': 0,
            'Points Lost between 1933 and 1963': 0,
            'Points Tied between 1933 and 1963': 0,
            }
    ...
    for index in range(1, len(file_contents)):
        ...
        if points_for > points_against:
            ...
            if year >= "1933" and year <= "1963":
                georgia_tournament_played[opponent]['Points Won between 1933 and 1963'] += points_for
        elif points_against == points_for:
            georgia_tournament_played[opponent]['Games Tied'] += 1
            if year >= "1933" and year <= "1963":
                georgia_tournament_played[opponent]['Points Tied between 1933 and 1963'] += points_for
        else:
            georgia_tournament_played[opponent]['Games Lost'] += 1
            georgia_tournament_played[opponent]['Total Points Lost by GT'] += points_against
            if year >= "1933" and year <= "1963":
                georgia_tournament_played[opponent]['Points Lost between 1933 and 1963'] += points_against
...
def calculate_all_time_scores_for_georgia_tech_at_home(georgia_score_table):
    ...
    for opponent in georgia_score_table.keys():
        total_games_won += georgia_score_table[opponent]['Points Won between 1933 and 1963']
        total_games_lost += georgia_score_table[opponent]['Points Lost between 1933 and 1963']
        total_games_tied += georgia_score_table[opponent]['Points Tied between 1933 and 1963']
...
#My answer for Q5:
# - For season2016.csv: 320-146-30
# - For their file:     4886-2008-62
