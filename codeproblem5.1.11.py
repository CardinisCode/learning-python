...
class Burrito:
    ...
    def get_cost(self):
        ...
        #To test my code to see if Rice and Beans work correctly: 
        if self.get_beans():
            print("Beans:", self.get_beans())
            base_cost += 0.5
            #If true, it would return 8.25
        if self.get_rice(): 
            print("Rice:", self.get_rice())
            base_cost += 0.5
            #IF true it would return 8.75
        return base_cost
...
#print: 7.75
#If there are beans += 0.5 -> 8.25
#


a_burrito = Burrito("tofu", False, "white", "black", extra_meat = True, guacamole = True)
