...
def reader(filename):
    ...
    for line in inputFile: 
        ...
        assignmentName = currentLineSplit[1]
        assignmentDict = {
            "number": int(currentLineSplit[0]),
            "grade": int(currentLineSplit[2]),
            "total": int(currentLineSplit[3]),
            "weight": float(currentLineSplit[4])
        } 

        fileContents[assignmentName] = assignmentDict
