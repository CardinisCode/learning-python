...
person4 = Person("David Joyner", 30, 903987653)
print(same_person(person1, person2))
print(same_person(person1, person3))
print(same_person(person1, person4))

#Their sample code: 
#def same_person(person_1, person_2):
#return person_1.get_GTID() == person_2.get_GTID()

#Their sample code is shorter and simpler, simply by putting everything
#in the return statement. 
#Plus they chose to use the getter() to get the value for GTID. 
#Not sure if this is the quickest route but it definitely does make use
#of the already available getters for each class variable. 
