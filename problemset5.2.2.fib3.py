...
#this is basically just a minor tweak from the usual fibonacci sequence
# which runs on there being 2 recursive function calls and they're only called if
# n is higher than 2 (as first [0] number and second [1] numbers are both 1)
# By default, if n isnt higher than 2, then it should return 1. 