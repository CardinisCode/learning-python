...
#observation: with the setters, I had to use the 'else' to ensure that 
# if the type was incorrect, that it would correctly change the attribute's value
# to None. 
# Otherwise, it would change the attribute to the new value, even the type was incorrect. 
