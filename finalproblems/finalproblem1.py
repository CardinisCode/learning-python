...
#Add your code here!
def to_dictionaries(countries):
    nations = {}
    for nation in countries: 
        print(nation.short_name)
        nations[nation.short_name] = {
            "long _name": nation.long_name, 
...
#We tested your code with nation_objects = [<ProgramInspector.Nation object at 0x7fcd0fcb4780>, <ProgramInspector.Nation object at 0x7fcd174b6160>]. 
#We expected to_dictionaries to return the dict
# {'Albania': {'long_name': 'Republic of Albania', 'iso_code': 8, 'iso_short': 'AL', 'iso_long': 'ALB', 'capital': 'Tirana'}, 
# 'Angola': {'long_name': 'Republic of Angola', 'iso_code': 24, 'iso_short': 'AO', 'iso_long': 'AGO', 'capital': 'Luanda'}}. 
# 
