...
# 
# Note that you should NOT try to
...
new_burrito = Burrito("chicken", True, True, False, True)
print("Meat:", new_burrito.get_meat())
print("To go:", new_burrito.get_to_go())
print("Rice:", new_burrito.get_rice())
print("Beans:", new_burrito.get_beans())
print("Extra Meat:", new_burrito.get_extra_meat())
print("Guacamole:", new_burrito.get_guacamole())
print("Cheese:", new_burrito.get_cheese())
print("Pico:", new_burrito.get_pico())
print("Corn:", new_burrito.get_corn())
