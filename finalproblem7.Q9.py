#Q9: What is one of the two teams that Georgia Tech has played, 
# and yet has never scored any points against? Name either team.
...
#My answer for Q9:
# - For season2016.csv: 'North Carolina'
# - For their file:     'Utah'