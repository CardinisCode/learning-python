...
def abstract_names(names):
    ...
    for list_of_fullnames in names:
        list_of_fullnames.sort()
        for full_name in list_of_fullnames:
            first_name = full_name.split(" ")[0]
            surname = full_name.split(" ")[1]
            if not first_name in names_database: 
                names_database[first_name] = []
            names_database[first_name].append(surname)
