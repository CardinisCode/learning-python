...
def sort_with_select(a_list):
    ...
    for i in range(len(a_list)):
        ...
        for j in range(i + 1, len(a_list)):
            ...
            print("Before:")
            print("i:", a_list[i], "and j:", a_list[j])

            if a_list[i] > a_list[j]:
                print("The first number is higher than the 2nd: True")
                higher_value = a_list[i]
                a_list[i] = a_list[j]
                a_list[j] = higher_value
                

            else: 
                print("Our 2nd value is smaller than the 1st")

            minIndex = i

            print("After:")
            print("i:", a_list[i], "and j:", a_list[j])
            print("So far our list looks like this:", a_list)
            print()
