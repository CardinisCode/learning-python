...
# Code scenario and how it wants the scenario/problem to be solved:
...
# I decided to use a dictionary to store the cards: "A", "0", "J", "Q", "K"
# - each with their own unique values. This (i believe) saved me a lot of time
# and saved a lot of processing required in the for-loop. 



#Add your code here!
def next_move(current_hand):
    card_values = {
        "A": 11, 
        "0": 10, 
        "J": 10, 
    ...
    if "A" in current_hand and points >= 22:
        points -= 10
